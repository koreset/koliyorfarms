<template>
  <div>
    <header id="top-bar" class="top-bar top-bar--style-1">
      <div class="top-bar__bg header-top-bar__bg"></div>
          ...
          <div id="top-bar__inner" class="top-bar__inner">
            <div>
              <nav
                ...
                class="top-bar__navigation navigation"
                role="navigation"
              >
                <ul>
                  ...
                  <li class="li-btn">
                    <a
                      class="custom-btn custom-btn--small custom-btn--style-4"
                      href="#"
                      >Get in Touch</a
                    >
                  </li>
    ...
    <div
      id="start-screen"
      class="start-screen start-screen--style-1"
    ...
    >
      <div id="start-screen__bg" class="start-screen__bg">
        <div id="vegas-slider" data-dots="true">
          <div class="vegas-control">
            <span id="vegas-control__prev" class="vegas-control__btn"
              >Prev</span
            >
            <span id="vegas-control__next" class="vegas-control__btn"
              >Next</span
            >
          </div>
        </div>
      ...
      <div
        id="start-screen__content-container"
        class="start-screen__content-container text-white"
      >
        <div
              ...
              <div class="col-12 col-md-10 col-xl-8">
                ...
                <p class="text-center mt-5 mt-md-10">
                  ...
                  <span class="d-block d-sm-none"
                    ><a
                      class="custom-btn custom-btn--small custom-btn--style-3"
                      href="#"
                      >Discover</a
                    ></span
                  >
        ...
        <div
          class="start-screen__content__item start-screen__content__item--2 align-items-center"
        >
          <div class="container">
            <div class="row align-items-center">
              <div class="col-12 col-md col-lg-9 col-xl-8">
                ...
                <h2 class="__title text-white">
                  Best harvest <br /><span>in the World</span>
                </h2>
              ...
              <div class="col-12 col-md-auto col-lg-3 col-xl-4 text-center">
                <a
                  class="play-btn"
                  data-fancybox=""
                  href="http://player.vimeo.com/video/44309170"
                >
                  <span></span>
                </a>
              </div>
        ...
        <div
          class="start-screen__content__item start-screen__content__item--3 align-items-center"
        >
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-md-auto col-xl-8">
                ...
                <h2 class="__title text-white">
                  Live<span style="color: #fcdb5a">stock</span>
                </h2>
    ...
    <main role="main">
                  ...
                  >
                    <i class="__ico">
                      <img
                        ...
                        src="img/blank.gif"
                        data-src="img/feature_img/1.png"
                        alt="demo"
                      />
                    </i>
                  ...
                  >
                    <i class="__ico">
                      <img
                        class="img-fluid lazy"
                        src="img/blank.gif"
                        data-src="img/feature_img/2.png"
                        alt="demo"
                      />
                    </i>
                  ...
                  >
                    <i class="__ico">
                      <img
                        class="img-fluid lazy"
                        src="img/blank.gif"
                        data-src="img/feature_img/3.png"
                        alt="demo"
                      />
                    </i>
                  ...
                  >
                    <i class="__ico">
                      <img
                        class="img-fluid lazy"
                        src="img/blank.gif"
                        data-src="img/feature_img/4.png"
                        alt="demo"
                      />
                    </i>
                  ...
                  >
                    <i class="__ico">
                      <img
                        class="img-fluid lazy"
                        src="img/blank.gif"
                        data-src="img/feature_img/5.png"
                        alt="demo"
                      />
                    </i>
                  ...
                  >
                    <i class="__ico">
                      <img
                        class="img-fluid lazy"
                        src="img/blank.gif"
                        data-src="img/feature_img/6.png"
                        alt="demo"
                      />
                    </i>
          ...
          <div class="row align-items-center">
            <div class="col-12 col-lg-4">
              <div
                ...
                ddata-aos-offset="100"
              >
                <div class="section-heading">
                  <h2 class="__title">About Koliyor <span>Farms</span></h2>
                </div>
                  ...
                  <div class="__item">
                    <figure class="__image">
                      <img
                        class="lazy"
                        src="img/blank.gif"
                        data-src="img/product-preview_img/1.jpg"
                        alt="demo"
                      />
                    </figure>
                  ...
                  <div class="__item">
                    <figure class="__image">
                      <img
                        class="lazy"
                        src="img/blank.gif"
                        data-src="img/product-preview_img/2.jpg"
                        alt="demo"
                      />
                    </figure>
      ...
      <section class="section section--no-pt section--no-pb section--gutter">
        <!-- start banner simple -->
        <div
          class="simple-banner simple-banner--style-1"
          data-aos="fade"
          data-aos-offset="50"
        >
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                  ...
                  >
                    ...
                    <span class="__date-post"> <strong>07</strong>Nov </span>
                  </div>
                </div>
                <!-- end item -->
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                  ...
                  >
                    ...
                    <span class="__date-post"> <strong>03</strong>Nov </span>
                  </div>
                </div>
                <!-- end item -->
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                  ...
                  >
                    ...
                    <div class="__content">
                      ...
                      <h3 class="__title h5">
                        <a href="blog_details.html"
                          >Superfoods you should be eating</a
                        >
                      </h3>
                    ...
                    <span class="__date-post"> <strong>25</strong>oct </span>
                  </div>
                </div>
                <!-- end item -->
              </div>
      ...
      <section class="section section--dark-bg">
        <div class="container">
          <div
            class="section-heading section-heading--center section-heading--white"
            data-aos="fade"
          >
          ...
          <form class="contact-form js-contact-form" action="#" data-aos="fade">
            ...
            <button
              class="custom-btn custom-btn--medium custom-btn--style-3 wide"
              type="submit"
              role="button"
            >
              Send
      ...
      <div class="container">
        ...
        <div class="row flex-lg-row-reverse">
          ...
          <div class="col-12 col-lg-6">
            <div class="footer__item">
              <span class="__copy"
                >© 2019 Agro. All rights reserved. Created by
                <a
                  class="__dev"
